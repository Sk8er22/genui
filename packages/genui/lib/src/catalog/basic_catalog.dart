...
import 'usecases/logic_gates.dart' as LogicGates;
...
import 'usecases/logic_pathfinding.dart' as LogicPathfinding;
...
import 'usecases/logic_poker.dart' as LogicPoker;
...
abstract final class BasicCatalogItems {
  ...
  static final List<CatalogItem> logicCatalogItems = [
    ...
    LogicGates.LogicGates.catalogItem,
    ...
    LogicPathfinding.LogicPathfinding.catalogItem,
    ...
    LogicPoker.LogicPoker.catalogItem,
